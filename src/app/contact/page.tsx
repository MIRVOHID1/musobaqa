                        ...
                        <div className="flex flex-col gap-4">
                            <div>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => <Input style={{ width: '100%', height: '56px' }}  placeholder="Name" {...field} status={errors.name ? "error" : ""}/>}
                                />
                            ...
                            <div>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => <TextArea style={{ width: '100%', height: '106px' }}  placeholder="Name" {...field} status={errors.name ? "error" : ""}/>}
                                />
